...
namespace Novanta\OrderPayment\Domain\OrderInvoice\QueryHandler;
...
interface GetOrderInvoicesHandlerInterface
{
    /**
     * @param GetOrderInvoices $query
     *
     * @return OrderInvoiceForViewing[]
     */
